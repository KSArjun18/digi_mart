...
const ProductDetails = () => {
  ...
  const handleZoomImage = useCallback((e) => {
    ...
    let x = e.clientX - imgContainer.left;
    let y = e.clientY - imgContainer.top;

    const cursorSize = 100; 
    x = Math.max(cursorSize / 2, Math.min(x, imgContainer.width - cursorSize / 2));
    y = Math.max(cursorSize / 2, Math.min(y, imgContainer.height - cursorSize / 2));
  ...
  return (
    <div className='container mx-auto p-4'>
      ...
      <img
        src={activeImage}
        className="relative overflow-hidden cursor-auto lg:cursor-crosshair bg-bw-bgsecondary-400"
      ...
      {zoomImage && (
        <>
          <div
            className="hidden lg:block absolute border border-gray-400 pointer-events-none"
            style={{
              width: "100px",
              height: "100px",
              left: `${zoomImageCoordinate.x}px`,
              top: `${zoomImageCoordinate.y}px`,
          ...
          <div className="hidden lg:block absolute min-w-[500px] overflow-hidden min-h-[400px] bg-slate-200 p-1 -right-[510px] top-0">
            <div
              ...
              style={{
                ...
                backgroundPosition: `${(zoomImageCoordinate.x / 300) * 100}% ${(zoomImageCoordinate.y / 300) * 100}%`,
                backgroundSize: "200%", // Enlarged zoom effect
              }}
            ></div>
          </div>
        </>
